...
class DataManager(QObject):
    ...
    def configure_views(self, ui: "Ui_MainWindow") -> None:
        ...
        # QML-based grid view handles rendering internally, so no delegate needed.
        # For widget-based grid views, we would create a delegate here.
        if not isinstance(ui.grid_view, GalleryQuickWidget):
