    ...
    try:
        ...
        if should_render:
            ...
            if image is not None:
                ...
                _LOGGER.error("Failed to render sidecar for %s, falling back to copy", source_path)
                # Fallback to copy if render fails but file exists?
                # Or skip? "Failed to render" implies corrupt data.
                # Let's fallback to copy to be safe, or just return False.
                return False
